...
\begin{contributions}
  \contribution{Ivan Petrenko}{data collection and preprocessing, EDA, manual annotation}
  \contribution{Olena Bondarenko}{model fine-tuning, experiments, hyperparameter tuning}
  \contribution{Andrii Kovalenko}{training infrastructure, web deployment demo, documentation}
\end{contributions}
